...
const About = () => {
  return (
    <>
      <section className="about bg-slate-50 px-5 pb-20 flex flex-col md:flex-row-reverse md:gap-10 items-center mt-32 md:px-10 lg:px-20">
        {/* <picture>
          <img src="/bg-curve-desktop.svg" alt="" />
        </picture> */}
